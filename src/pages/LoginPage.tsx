  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (mode === 'signup') {
        ...
        if (err) throw err
        // signUp auto-confirms the session when "Confirm email" is off in
        // the Supabase dashboard, so onAuthStateChange fires immediately
        // and the shell will render the OnboardingPage.
      } else {
